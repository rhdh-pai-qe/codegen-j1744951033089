...
3) Access the `workbench` named `codegen-j1744951033089-notebook`.
...
5) In the terminal, run `cd codegen-j1744951033089` to navigate to your sample app's directory.
